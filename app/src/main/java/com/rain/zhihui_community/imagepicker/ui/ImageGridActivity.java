package com.rain.zhihui_community.imagepicker.ui;
...
import com.rain.zhihui_community.imagepicker.ImageDataSource;
import com.rain.zhihui_community.imagepicker.ImagePicker;
import com.rain.zhihui_community.imagepicker.Utils;
import com.rain.zhihui_community.imagepicker.adapter.ImageFolderAdapter;
import com.rain.zhihui_community.imagepicker.adapter.ImageGridAdapter;
import com.rain.zhihui_community.imagepicker.bean.ImageFolder;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_ok) {
            int i = IssueHouseActivity.list.size();
            int z = imagePicker.getSelectedImages().size();
            if ((i + z) > 10) {
                WinToast.toast(this, "您已经选了" + (i - 1) + "张,最多可再选" + (10 - i) + "张图片");
            } else {
