package com.rain.zhihui_community.ui.view.menuview;
...
import com.rain.zhihui_community.ui.view.menuview.Interface.IDynamicSore;
...
public class DynamicSoreView<T> extends LinearLayout {
    ...
    public DynamicSoreView(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            //选中点
            RadioSelect = typedArray.getResourceId(R.styleable.DynamicSoreView_SoreRadioSelect, fj.mtsortbutton.lib.R.drawable.radio_select);
            //未选中点
            RadioUnselected = typedArray.getResourceId(R.styleable.DynamicSoreView_SoreRadioUnselected, fj.mtsortbutton.lib.R.drawable.radio_unselected);
            //圆点间距
