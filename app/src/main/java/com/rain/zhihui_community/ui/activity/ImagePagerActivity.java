...
public class ImagePagerActivity extends BaseAppAvtivity {
    ...
    private List<ImageIssueData> imgUrls;
    ...
    public static void startImagePagerActivity(Context context, List<ImageIssueData> imgUrls, int position, ImageSize imageSize) {
        Log.i(TAG, "startImagePagerActivity: " + imgUrls.toString() + "=======" + position);
    ...
    private void addGuideView(LinearLayout guideGroup, int startPos, List<ImageIssueData> imgUrls) {
    ...
    private static class ImageAdapter extends PagerAdapter {
        private List<ImageIssueData> datas = new ArrayList<ImageIssueData>();
        private LayoutInflater inflater;
        private Context context;
        private ImageSize imageSize;
        private ImageView smallImageView = null;

        public void setDatas(List<ImageIssueData> datas) {
            if (datas != null)
                this.datas = datas;
        }
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (view != null) {
                ...
                ImageIssueData issueData = datas.get(position);
                if (issueData.isFile()) {
                    File file = issueData.getFile();
                    Glide.with(context)
                            .load(file)
                            .diskCacheStrategy(DiskCacheStrategy.ALL)//缓存多个尺寸
                            .thumbnail(0.1f)//先显示缩略图  缩略图为原图的1/10
                            .placeholder(R.drawable.perch)//设置占位图
                            .error(R.drawable.perch)
                    ...
                    final String imgurl = BaseApiService.BASE_URL + datas.get(position).getStrPath();
                    Glide.with(context)
                            .load(imgurl)
                            .diskCacheStrategy(DiskCacheStrategy.ALL)//缓存多个尺寸
//                            .thumbnail(0.1f)//先显示缩略图  缩略图为原图的1/10
    ...
    private void getIntentData() {
        ...
        imgUrls = (ArrayList<ImageIssueData>) getIntent().getSerializableExtra(INTENT_IMGURLS);
