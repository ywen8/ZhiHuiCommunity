...
public class GovernmentComplaintActivity extends BaseAppAvtivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_government_complaint);
        ButterKnife.bind(this);
        TitleUtls.TitleItemView(this, "投诉建议");
