...
public class CommunityServiceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.layout_community_service_item, null);
        ...
        ImageUtils.image(context, BaseApiService.BASE_URL + bannerItem.getImg(), viewHolder.iv_iamge);
        return convertView;
    }
